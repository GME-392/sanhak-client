      ...
      case "contest":
        return (
          <div className="Guide__content__container">
            <h3 className={`GuideMenu__title title--${type}`}>👍 이런 분들께 추천드려요</h3>
            ...
            <h3 className={`GuideMenu__title title--${type}`} style={{ marginTop: "2.5rem" }}>
              🎨 관련 태그
            </h3>
            <div className="Guide__tag__container">
              ...
              />
              <Tag name={"CodeJam"} onAddTag={() => setTagList([...tagList, "CodeJam"])} />
              <Tag name={"ACM-ICPC"} onAddTag={() => setTagList([...tagList, "ACM-ICPC"])} />
              <Tag name={"TopCoder"} onAddTag={() => setTagList([...tagList, "TopCoder"])} />
              <Tag name={"CodeForce"} onAddTag={() => setTagList([...tagList, "CodeForce"])} />
            </div>
      ...
      case "study":
        return (
          <div className="Guide__content__container">
            ...
            <div className="Guide__tag__container">
              <Tag name={"파이썬"} onAddTag={() => setTagList([...tagList, "파이썬"])} />
              <Tag name={"C++"} onAddTag={() => setTagList([...tagList, "C++"])} />
              <Tag name={"대학생"} onAddTag={() => setTagList([...tagList, "대학생"])} />
              <Tag name={"자바"} onAddTag={() => setTagList([...tagList, "자바"])} />
              <Tag name={"기초"} onAddTag={() => setTagList([...tagList, "기초"])} />
              <Tag name={"연습"} onAddTag={() => setTagList([...tagList, "연습"])} />
            </div>
            <div className="Guide__button__container">
              <button className={`Guide__button Guide__button`}>태그로 그룹 찾기</button>
              <button className={`Guide__button Guide__button--secondary`} onClick={handleShow}>
      ...
      case "job":
        return (
          <div className="Guide__content__container">
            ...
            <div className="Guide__tag__container">
              <Tag name={"삼성"} onAddTag={() => setTagList([...tagList, "삼성"])} />
              <Tag name={"LG"} onAddTag={() => setTagList([...tagList, "LG"])} />
              <Tag name={"카카오"} onAddTag={() => setTagList([...tagList, "카카오"])} />
              <Tag name={"네이버"} onAddTag={() => setTagList([...tagList, "네이버"])} />
              <Tag name={"대기업"} onAddTag={() => setTagList([...tagList, "대기업"])} />
              <Tag name={"코테"} onAddTag={() => setTagList([...tagList, "코테"])} />
            </div>
            <div className="Guide__button__container">
              <button className={`Guide__button Guide__button`}>태그로 그룹 찾기</button>
              <button className={`Guide__button Guide__button--secondary`} onClick={handleShow}>
  ...
  return (
    <div className="GuideMenu__container">
      ...
      <div style={{ marginLeft: "5rem", width: "300px" }}>
        <h3 className={`GuideMenu__title title--${type}`} style={{ marginBottom: "1rem" }}>
          🖥 추천 그룹 목록
        </h3>
